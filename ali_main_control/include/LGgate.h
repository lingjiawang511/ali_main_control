...
#define				LEFT_SHIPMENT_IO					   	GPIO_Pin_4
#define				LEFT_SHIPMENT_PORT			   		GPIOC
#define				LEFT_SHIPMENT_RCC					 		RCC_APB2Periph_GPIOC
#define				RIGHT_SHIPMENT_IO					 		GPIO_Pin_7
#define				RIGHT_SHIPMENT_PORT				 		GPIOC
#define				RIGHT_SHIPMENT_RCC			  	 	RCC_APB2Periph_GPIOC

#define				GETOUT_MEDICINE_IO					 	GPIO_Pin_3
#define				GETOUT_MEDICINE_PORT				 	GPIOB
#define				GETOUT_MEDICINE_RCC			  	 	RCC_APB2Periph_GPIOB

#define READ_LEFT_SHIPMENT_SENSOR    		GPIO_ReadInputDataBit(LEFT_SHIPMENT_PORT,LEFT_SHIPMENT_IO)
#define READ_RIGHT_SHIPMENT_SENSOR    	GPIO_ReadInputDataBit(RIGHT_SHIPMENT_PORT,RIGHT_SHIPMENT_IO)
#define READ_GETOUT_MEDICINE_SENSOR    	GPIO_ReadInputDataBit(GETOUT_MEDICINE_PORT,GETOUT_MEDICINE_IO)
